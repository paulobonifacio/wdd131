document.addEventListener("DOMContentLoaded", function() {
    // Log para garantir que o DOM foi carregado
    ...
    // Função para criar um card de templo
    ...
    // Função para renderizar os templos
    const renderTemples = (filter = 'home') => {
        gallery.innerHTML = '';
    ...
    // Render inicial
    renderTemples(); // Carrega todos os templos inicialmente
});
